package com.se.spring_boot_jwt_tranthaiminhtan.util;
...
public class JwtUtil {
    ...
    private static final String USER = "MinhTan";
    private static final String SECRET = "hey Mr Tan the secrect length must be at least 256 bits" +
                                             " please no reveal!";
